...
class SnailEnemy(enemySprite: Sprite) : Enemy() {
    ...
    init {
        ...
        animationLeft = Animation(frameDuration, SnailEnemyAnimation().getAnimationFrames(isFacingLeft = true))
        animationRight = Animation(frameDuration, SnailEnemyAnimation().getAnimationFrames(isFacingRight = true))
    }
    ...
    override fun update(delta: Float) {
        if (isActive) {
            ...
            //increase the amount of seconds the snail has spent in current animation state
