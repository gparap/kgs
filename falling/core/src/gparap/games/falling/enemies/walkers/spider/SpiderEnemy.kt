...
class SpiderEnemy(enemySprite: Sprite) : Enemy() {
    ...
    init {
        ...
        animationLeft = Animation(frameDuration, SpiderEnemyAnimation().getAnimationFrames(isFacingLeft = true))
        animationRight = Animation(frameDuration, SpiderEnemyAnimation().getAnimationFrames(isFacingRight = true))
    }
